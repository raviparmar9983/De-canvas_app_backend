...
let IdeationService = class IdeationService {
    ...
    workingIdeation(projectId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const ideation = yield this.ideationModel.findOne({ projectId });
            if (ideation) {
                return yield this.ideationModel.updateOne({ projectId }, Object.assign({}, data), { runValidators: true });
            }
            let newdata = data;
            newdata.projectId = new mongoose_1.Types.ObjectId(projectId);
            return yield this.ideationModel.create(newdata);
        });
    }
...
IdeationService = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(type_1.TYPES.ideationModel)),
    __metadata("design:paramtypes", [mongoose_1.default.Model])
], IdeationService);
exports.default = IdeationService;
